// // src/components/ReturnReplaceRequests.js
...
//             const response = await axios.get('http://localhost:5000/api/return-replace/admin/pending', {
...
//             const token = localStorage.getItem('token');
//             await axios.post(
//                 'http://localhost:5000/api/return-replace/admin/assign-pickup',
...
//                 const token = localStorage.getItem('token');
//                 await axios.post(
//                     'http://localhost:5000/api/return-replace/admin/reject-request',
//                     { requestId },
//                     { headers: { Authorization: `Bearer ${token}` } }
//                 );
