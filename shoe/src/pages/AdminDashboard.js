...
// import AssignedPickups from './AssignedPickups'; // Assuming you have this file
...
//                 axios.get('http://localhost:5000/api/orders/unassigned', { headers: { Authorization: `Bearer ${token}` } }),
//                 axios.get('http://localhost:5000/api/users/delivery-partners', { headers: { Authorization: `Bearer ${token}` } }),
//                 axios.get('http://localhost:5000/api/orders/assigned', { headers: { Authorization: `Bearer ${token}` } }),
//             ]);
...
//             const token = localStorage.getItem('token');
//             await axios.post(
//                 `http://localhost:5000/api/delivery/admin/update-status/${orderId}`,
//                 { status },
//                 { headers: { Authorization: `Bearer ${token}` } }
//             );
...
//                         <p className="mb-2"><strong>Order:</strong> {orderToAssign.user?.name}'s order</p>
